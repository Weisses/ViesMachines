...
public class RenderKitFabricator extends TileEntitySpecialRenderer<TileEntityKitFabricator> {
	...
	public RenderKitFabricator() 
	{
		this.model = new ModelKitFabricator();
		this.modelpowered = new ModelKitFabricatorPowered();
	}
	
	@Override
	public void render(TileEntityKitFabricator te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
	{
	...
	public boolean isGlobalRenderer(TileEntityKitFabricator te) 
	{
        return true;
    }
