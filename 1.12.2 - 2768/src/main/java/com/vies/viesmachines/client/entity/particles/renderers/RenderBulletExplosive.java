...
public class RenderBulletExplosive extends Render<EntityBulletExplosive> {
	
	private Item itemModel = ItemsVM.PARTICLE_BULLET_EXPLOSIVE;
	private float scale;
    
    public RenderBulletExplosive(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityBulletExplosive entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityBulletExplosive entity)
    {
