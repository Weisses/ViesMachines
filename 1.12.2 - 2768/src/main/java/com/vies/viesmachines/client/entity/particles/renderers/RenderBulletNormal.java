...
public class RenderBulletNormal extends Render<EntityBulletNormal> {
	
	private Item itemModel = ItemsVM.PARTICLE_BULLET_NORMAL;
	private float scale;
    
    public RenderBulletNormal(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityBulletNormal entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityBulletNormal entity)
    {
