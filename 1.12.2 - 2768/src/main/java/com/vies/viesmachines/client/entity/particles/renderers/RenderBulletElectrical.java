...
public class RenderBulletElectrical extends Render<EntityBulletElectrical> {
	
	private Item itemModel = ItemsVM.PARTICLE_BULLET_ELECTRICAL;
	private float scale;
    
    public RenderBulletElectrical(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityBulletElectrical entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityBulletElectrical entity)
    {
