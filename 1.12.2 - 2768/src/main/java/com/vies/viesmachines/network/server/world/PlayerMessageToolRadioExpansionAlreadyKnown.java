...
public class PlayerMessageToolRadioExpansionAlreadyKnown extends MessageBase<PlayerMessageToolRadioExpansionAlreadyKnown> {
	...
	@Override
	public void handleClientSide(PlayerMessageToolRadioExpansionAlreadyKnown message, EntityPlayer player) 
	{
