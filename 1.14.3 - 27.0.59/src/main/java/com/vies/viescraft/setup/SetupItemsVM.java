...
import com.vies.viescraft.main.items.ItemGeneric;
...
public class SetupItemsVM {
	
	public static final Set<Item> ITEMS = new HashSet<>();
	
	private static Item.Properties properties = new Item.Properties();
	
	public static final Item XEGONITE = new ItemGeneric("xegonite", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	public static final Item XEGONITE_WATER = new ItemGeneric("xegonite_water", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	public static final Item XEGONITE_LAVA = new ItemGeneric("xegonite_lava", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	
	public static final Item XEGONITE_ENDER = new ItemGeneric("xegonite_ender", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	public static final Item LOGIC_CIRCUIT = new ItemGeneric("logic_circuit", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	public static final Item ADAPTIVE_CIRCUIT = new ItemGeneric("adaptive_circuit", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems, "vc.item");
	
	//public static final Item KIT_BLANK = new ItemGeneric("kits/kit_blank", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems);
	//public static final Item KIT_UPGRADE_MAX = new ItemGeneric("kits/item_admin_upgrade_max", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems);
	//public static final Item KIT_MACHINE_MAX = new ItemGeneric("kits/item_admin_machine_max", properties, 64, Rarity.EPIC, ViesCraft.setup.itemGroupItems);
	
	//===============================================================
	
	/*
	//public static final Item XEGONITE = new ItemGeneric("xegonite", EnumRarity.COMMON);
