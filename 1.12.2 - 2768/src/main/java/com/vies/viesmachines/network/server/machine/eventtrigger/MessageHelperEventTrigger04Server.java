...
public class MessageHelperEventTrigger04Server extends MessageBase<MessageHelperEventTrigger04Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger04Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger04Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger04Client(), 
