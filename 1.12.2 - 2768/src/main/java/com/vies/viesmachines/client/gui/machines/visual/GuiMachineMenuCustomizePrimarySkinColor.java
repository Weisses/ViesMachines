...
public class GuiMachineMenuCustomizePrimarySkinColor extends GuiContainerVC {
	...
	public GuiMachineMenuCustomizePrimarySkinColor(IInventory playerInv, EntityMachineBase airshipIn)
	{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		GlStateManager.pushMatrix();
		{
			...
			this.centeredString(fontRenderer, References.localNameVC("viesmachines.gui.tt.customize.primarycolor.primarycolor.0"), 74, 16, Color.BLACK.getRGB());
		}
		GlStateManager.popMatrix();
	...
	public void updateScreen()
    {
		...
		&& this.isShiftKeyDown())
 		...
 		if (this.machine.getVisualFrameColorRed() == this.textRedNumber
		&& this.machine.getVisualFrameColorGreen() == this.textGreenNumber
		&& this.machine.getVisualFrameColorBlue() == this.textBlueNumber)
 		{
    ...
    protected void drawEntityOnScreen(int posX, int posY, int horizontalIn, int scale, Entity entityIn, boolean ridingEntityIn)
    {
		...
		boolean currentColor = machineIn.getVisualFrameColor();
    	int currentR = machineIn.getVisualFrameColorRed();
        ...
        machineIn.setVisualFrameColor(currentColor);
    	machineIn.setVisualFrameColorRed(currentR);
    	machineIn.setVisualFrameColorGreen(currentG);
    	machineIn.setVisualFrameColorBlue(currentB);
    }
}
