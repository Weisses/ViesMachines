package com.vies.viescraft.api.enums;
...
public class EnumsVM {
	...
	public static enum VisualMachineTexture
    {
		...
		DEFAULT(0, "default", SetupBlocksVM.XEGONITE_BASIC, 0),
    	...
    	WATER(44, "water", SetupBlocksVM.WATER_BASIC, 0), 
    	LAVA(45, "lava", SetupBlocksVM.LAVA_BASIC, 0), 
    	ENDER(46, "ender", SetupBlocksVM.ENDER_BASIC, 0);
	...
	public static enum VisualDisplaySymbol
    {
		...
		// General:
		SYMBOL_LOGOFORGE(0, "forge", SetupItemsVM.SYMBOL_LOGOFORGE),
		SYMBOL_COINSTACK(1, "coinstack", SetupItemsVM.SYMBOL_COINSTACK),
		SYMBOL_SCROLL(2, "scroll", SetupItemsVM.SYMBOL_SCROLL),
		SYMBOL_WRENCH(3, "wrench", SetupItemsVM.SYMBOL_WRENCH),
		SYMBOL_KEY(4, "key", SetupItemsVM.SYMBOL_KEY),
		SYMBOL_PADLOCK(5, "padlock", SetupItemsVM.SYMBOL_PADLOCK),
		SYMBOL_BELL(6, "bell", SetupItemsVM.SYMBOL_BELL),
		SYMBOL_ANCHOR(7, "anchor", SetupItemsVM.SYMBOL_ANCHOR),
		SYMBOL_BARREL(8, "barrel", SetupItemsVM.SYMBOL_BARREL),
		SYMBOL_GEARS(9, "gears", SetupItemsVM.SYMBOL_GEARS);
	...
	public static enum VisualDisplaySymbolHoliday
    {
		// STRING(meta, localized name, item):
		// New Years:
		SYMBOL_NEWYEARS_0(0, "newyears_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_NEWYEARS_1(1, "newyears_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_NEWYEARS_2(2, "newyears_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_NEWYEARS_3(3, "newyears_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_NEWYEARS_4(4, "newyears_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_NEWYEARS_5(5, "newyears_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_NEWYEARS_6(6, "newyears_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_NEWYEARS_7(7, "newyears_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_NEWYEARS_8(8, "newyears_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_NEWYEARS_9(9, "newyears_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// Valentine's Day:
		SYMBOL_VALENTINESDAY_0(10, "valentinesday_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_VALENTINESDAY_1(11, "valentinesday_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_VALENTINESDAY_2(12, "valentinesday_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_VALENTINESDAY_3(13, "valentinesday_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_VALENTINESDAY_4(14, "valentinesday_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_VALENTINESDAY_5(15, "valentinesday_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_VALENTINESDAY_6(16, "valentinesday_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_VALENTINESDAY_7(17, "valentinesday_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_VALENTINESDAY_8(18, "valentinesday_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_VALENTINESDAY_9(19, "valentinesday_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// Easter:
		SYMBOL_EASTER_0(20, "easter_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_EASTER_1(21, "easter_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_EASTER_2(22, "easter_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_EASTER_3(23, "easter_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_EASTER_4(24, "easter_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_EASTER_5(25, "easter_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_EASTER_6(26, "easter_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_EASTER_7(27, "easter_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_EASTER_8(28, "easter_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_EASTER_9(29, "easter_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// 4th of July:
		SYMBOL_4THOFJULY_0(30, "4thofjuly_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_4THOFJULY_1(31, "4thofjuly_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_4THOFJULY_2(32, "4thofjuly_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_4THOFJULY_3(33, "4thofjuly_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_4THOFJULY_4(34, "4thofjuly_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_4THOFJULY_5(35, "4thofjuly_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_4THOFJULY_6(36, "4thofjuly_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_4THOFJULY_7(37, "4thofjuly_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_4THOFJULY_8(38, "4thofjuly_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_4THOFJULY_9(39, "4thofjuly_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// Halloween:
		SYMBOL_HALLOWEEN_0(40, "halloween_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_HALLOWEEN_1(41, "halloween_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_HALLOWEEN_2(42, "halloween_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_HALLOWEEN_3(43, "halloween_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_HALLOWEEN_4(44, "halloween_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_HALLOWEEN_5(45, "halloween_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_HALLOWEEN_6(46, "halloween_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_HALLOWEEN_7(47, "halloween_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_HALLOWEEN_8(48, "halloween_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_HALLOWEEN_9(49, "halloween_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// Thanksgiving:
		SYMBOL_THANKSGIVING_0(50, "thanksgiving_0", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_THANKSGIVING_1(51, "thanksgiving_1", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_THANKSGIVING_2(52, "thanksgiving_2", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_THANKSGIVING_3(53, "thanksgiving_3", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_THANKSGIVING_4(54, "thanksgiving_4", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_THANKSGIVING_5(55, "thanksgiving_5", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_THANKSGIVING_6(56, "thanksgiving_6", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_THANKSGIVING_7(57, "thanksgiving_7", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_THANKSGIVING_8(58, "thanksgiving_8", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_THANKSGIVING_9(59, "thanksgiving_9", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON),
		
		// Christmas:
		SYMBOL_CHRISTMAS_TREE(60, "christmas_tree", SetupItemsVM.SYMBOL_CHRISTMAS_TREE),
		SYMBOL_CHRISTMAS_WREATH(61, "christmas_wreath", SetupItemsVM.SYMBOL_CHRISTMAS_WREATH),
		SYMBOL_CHRISTMAS_ORNAMENT(62, "christmas_ornament", SetupItemsVM.SYMBOL_CHRISTMAS_ORNAMENT),
		SYMBOL_CHRISTMAS_STOCKING(63, "christmas_stocking", SetupItemsVM.SYMBOL_CHRISTMAS_STOCKING),
		SYMBOL_CHRISTMAS_NIGHTSKY(64, "christmas_nightsky", SetupItemsVM.SYMBOL_CHRISTMAS_NIGHTSKY),
		SYMBOL_CHRISTMAS_GRINCH(65, "christmas_grinch", SetupItemsVM.SYMBOL_CHRISTMAS_GRINCH),
		SYMBOL_CHRISTMAS_MAX(66, "christmas_max", SetupItemsVM.SYMBOL_CHRISTMAS_MAX),
		SYMBOL_CHRISTMAS_FROSTY(67, "christmas_frosty", SetupItemsVM.SYMBOL_CHRISTMAS_FROSTY),
		SYMBOL_CHRISTMAS_PEANUTS(68, "christmas_peanuts", SetupItemsVM.SYMBOL_CHRISTMAS_PEANUTS),
		SYMBOL_CHRISTMAS_POKEMON(69, "christmas_pokemon", SetupItemsVM.SYMBOL_CHRISTMAS_POKEMON);
